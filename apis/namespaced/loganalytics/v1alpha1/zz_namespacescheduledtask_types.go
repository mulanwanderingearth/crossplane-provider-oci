...
type MetricCollectionsInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	QueryTableNameRef *v1.NamespacedReference `json:"queryTableNameRef,omitempty" tf:"-"`

	// Selector for a Table in nosql to populate queryTableName.
	// +kubebuilder:validation:Optional
	QueryTableNameSelector *v1.NamespacedSelector `json:"queryTableNameSelector,omitempty" tf:"-"`
}
