...
type SenderInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/cluster/email/v1alpha1.EmailIpPool
	...
	// +kubebuilder:validation:Optional
	EmailIPPoolIDRef *v1.Reference `json:"emailIpPoolIdRef,omitempty" tf:"-"`
