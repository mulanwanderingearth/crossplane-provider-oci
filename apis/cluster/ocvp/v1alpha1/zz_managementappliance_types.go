...
type ConfigurationInitParameters struct {
	...
	SupportBundleBucketIDRef *v1.Reference `json:"supportBundleBucketIdRef,omitempty" tf:"-"`

	// Selector for a Bucket in objectstorage to populate supportBundleBucketId.
	// +kubebuilder:validation:Optional
	SupportBundleBucketIDSelector *v1.Selector `json:"supportBundleBucketIdSelector,omitempty" tf:"-"`
}
...
type ConnectionsInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	CredentialsSecretIDRef *v1.Reference `json:"credentialsSecretIdRef,omitempty" tf:"-"`

	// Selector for a Secret in vault to populate credentialsSecretId.
	// +kubebuilder:validation:Optional
	CredentialsSecretIDSelector *v1.Selector `json:"credentialsSecretIdSelector,omitempty" tf:"-"`
