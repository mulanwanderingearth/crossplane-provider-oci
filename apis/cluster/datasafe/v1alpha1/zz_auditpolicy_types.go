...
type AuditPolicyInitParameters struct {
	...
	ProvisionTrigger *int64 `json:"provisionTrigger,omitempty" tf:"provision_trigger,omitempty"`

	// (Updatable) An optional property when incremented triggers Retrieve From Target. Could be set to any integer value.
	RetrieveFromTargetTrigger *int64 `json:"retrieveFromTargetTrigger,omitempty" tf:"retrieve_from_target_trigger,omitempty"`
}
