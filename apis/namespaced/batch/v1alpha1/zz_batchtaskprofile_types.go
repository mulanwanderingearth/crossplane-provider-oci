...
type BatchTaskProfileParameters struct {
	...
	// Extended information for the task profile.
	// +kubebuilder:validation:Optional
	ExtendedInformation []ExtendedInformationParameters `json:"extendedInformation,omitempty" tf:"extended_information,omitempty"`
...
type ExtendedInformationObservation struct {
...
type ExtendedInformationParameters struct {
