...
func (mg *ByolAllocation) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("ocvp.oci.upbound.io", "v1alpha1", "Byol", "ByolList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *Cluster) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	for i3 := 0; i3 < len(mg.Spec.ForProvider.ClusterByolAllocationDetails); i3++ {
		{
			m, l, err = apisresolver.GetManagedResource("ocvp.oci.upbound.io", "v1alpha1", "ByolAllocation", "ByolAllocationList")
			if err != nil {
				return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
			}
			rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
