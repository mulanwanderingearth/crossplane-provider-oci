...
func (mg *CostAnomalyEvent) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("budget.oci.upbound.io", "v1alpha1", "CostAnomalyEvent", "CostAnomalyEventList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *CostAnomalyMonitor) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	for i3 := 0; i3 < len(mg.Spec.ForProvider.CostAlertSubscriptionMap); i3++ {
		{
			m, l, err = apisresolver.GetManagedResource("budget.oci.upbound.io", "v1alpha1", "CostAlertSubscription", "CostAlertSubscriptionList")
			if err != nil {
				return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
			}
			rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
...
func (mg *CostAnomalyMonitorCostanomalymonitorenabletogglesManagement) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("budget.oci.upbound.io", "v1alpha1", "CostAnomalyMonitor", "CostAnomalyMonitorList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
