...
type OmkInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/oracle/provider-oci/apis/cluster/loganalytics/v1alpha1.Namespace
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
	...
	// +kubebuilder:validation:Optional
	ClusterNamespaceIDRef *v1.Reference `json:"clusterNamespaceIdRef,omitempty" tf:"-"`

	// Selector for a Namespace in loganalytics to populate clusterNamespaceId.
	// +kubebuilder:validation:Optional
	ClusterNamespaceIDSelector *v1.Selector `json:"clusterNamespaceIdSelector,omitempty" tf:"-"`
